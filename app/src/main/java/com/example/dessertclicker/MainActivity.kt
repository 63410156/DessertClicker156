...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "onCreate Called 63410156")
        setContent {
            DessertClickerTheme {
    ...
    override fun onStart() {
        super.onStart()
        Log.d(TAG, "onStart Called 63410156")
    }

    override fun onResume() {
        super.onResume()
        Log.d(TAG, "onResume Called 63410156")
    }

    override fun onRestart() {
        super.onRestart()
        Log.d(TAG, "onRestart Called 63410156")
    }

    override fun onPause() {
        super.onPause()
        Log.d(TAG, "onPause Called 63410156")
    }

    override fun onStop() {
        super.onStop()
        Log.d(TAG, "onStop Called 63410156")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "onDestroy Called 63410156")
